...
const char* ssid = "Galaxy S104796";
const char* password = "egyt0484";
long rssi = 0;
...
void loop() 
{
    ...
    {
      String req = "https://api.thingspeak.com/update.json?api_key=CJHE6865NN1CKBHV&field1=1&field2=" + String(lastX, 8) + "&field3=" + String(lastY, 8);
